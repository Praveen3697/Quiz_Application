...
public class Quiz extends JFrame implements ActionListener{
    ...
    Quiz(String username)
    {
        ...
        lifeLine.setBounds(950,435,150,30);
        ...
        Submit.setBounds(950,495,150,30);
    ...
    public void paint(Graphics g)
    {
        ...
        if(timer > 0)
        {
            g.drawString(time,940,345);
        }
        else
        {
            g.drawString("Times Up!!",940,345);
        }
